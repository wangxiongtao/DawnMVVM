...
class MyPath extends Action {
	...
	public void draw(Canvas canvas) {
		...
		paint.setPathEffect(new CornerPathEffect(200f));
...
class MyLine extends Action {
	...
	MyLine(float x, float y, float size, int color) {
		super(color);
		startX = x;
		startY = y;
		stopX = x;
...
class MyRect extends Action {
	...
	MyRect(float x, float y, float size, int color) {
		super(color);
		startX = x;
		startY = y;
		stopX = x;
...
class MyCircle extends Action {
	...
	MyCircle(float x, float y, float size, int color) {
		super(color);
		startX = x;
		startY = y;
		stopX = x;
...
class MyFillRect extends Action {
	...
	MyFillRect(float x, float y, float size, int color) {
		super(color);
		startX = x;
		startY = y;
		stopX = x;
...
class MyFillCircle extends Action {
	...
	MyFillCircle(float x, float y, float size, int color) {
		super(color);
		startX = x;
		startY = y;
		stopX = x;
