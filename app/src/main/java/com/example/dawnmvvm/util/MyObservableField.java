 ...
 */
public class MyObservableField<T> extends MyBaseObservableField implements Serializable {
     ...
     */
    public MyObservableField(T value) {
        mValue = value;
    }
     ...
     */
    public MyObservableField(Observable... dependencies) {
        super(dependencies);
    }
